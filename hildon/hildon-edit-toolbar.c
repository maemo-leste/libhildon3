...
G_DEFINE_TYPE                                   (HildonEditToolbar, hildon_edit_toolbar, GTK_TYPE_BOX);
...
hildon_edit_toolbar_init                        (HildonEditToolbar *self)
{
    ...
    priv->hbox = GTK_BOX (gtk_box_new (GTK_ORIENTATION_HORIZONTAL, 0));
    gtk_widget_set_halign (GTK_WIDGET (priv->hbox), GTK_ALIGN_START);
    gtk_widget_set_valign (GTK_WIDGET (priv->hbox), GTK_ALIGN_CENTER);
    ...
    gtk_widget_set_margin_start (GTK_WIDGET (priv->hbox), TOOLBAR_LEFT_PADDING);
    gtk_widget_set_margin_end (GTK_WIDGET (priv->hbox), TOOLBAR_LEFT_PADDING);
    gtk_widget_set_margin_top (GTK_WIDGET (priv->hbox), TOOLBAR_RIGHT_PADDING);
    gtk_widget_set_margin_bottom (GTK_WIDGET (priv->hbox), TOOLBAR_RIGHT_PADDING);
    ...
    gtk_box_pack_start (hbox, GTK_WIDGET (priv->hbox), TRUE, TRUE, 0);
    ...
    gtk_widget_set_halign (GTK_WIDGET (priv->animation), GTK_ALIGN_START);
    gtk_widget_set_valign (GTK_WIDGET (priv->animation), GTK_ALIGN_CENTER);
